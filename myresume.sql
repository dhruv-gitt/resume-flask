...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2023 at 09:56 PM
...
--
ALTER TABLE `blog`
  MODIFY `sno` int(111) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `contacts`
--
ALTER TABLE `contacts`
  MODIFY `Sno` int(111) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
COMMIT;
